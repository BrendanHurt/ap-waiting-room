...
urlpatterns = [
    ...
    path("<int:lobby_id>/join", views.join_lobby_view, name="join_lobby"),
    path("<int:lobby_id>/add_slot/yamls", views.add_slot_form_view, name="add_slot_form"),
    path("<int:lobby_id>/add_slot", views.add_slot_view, name="add_slot"),
